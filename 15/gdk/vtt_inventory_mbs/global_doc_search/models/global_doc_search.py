...
class SearchDocument(models.Model):
    ...
    def has_global_search_enabled(self):      
        ...
        if self.env.company.sh_global_document_search_is_enable and self.env.user.has_group('vtt_inventory_mbs.group_vtt_inventory_mbs_global_document_search'):
    ...
    def _search_document_all(self,barcode):
        ...
        if result and self.env.company.sh_global_document_search_is_picking:
