...
def validate_token(func):
    ...
    def wrap(self, *args, **kwargs):
        ...
        # Kiểm tra chế độ bảo trì sau khi xác thực token thành công
        # try:
        #     maintenance_mode = request.env['ir.config_parameter'].sudo().get_param(
        #         'vtt_namanh_zalo_mini_app.zalo_maintenance')
        #     if maintenance_mode == 'True':  # safe check with string value
        #         return {
        #             'success': False,
