...
""",
    ...
    'assets': {
        'web.assets_backend': [
            'vtt_sale_subscription/static/src/js/tours/sale_subscription.js',
            'vtt_sale_subscription/static/src/scss/sale_subscription_backend.scss',
        ],
        'web.assets_frontend': [
            'vtt_sale_subscription/static/src/js/portal_subscription.js',
        ],
    }
}
