...
export class HierarchyTreeRender extends ListRenderer {
    ...
    getRowLevel(record) {
        return record.data['hierarchy_level'];
    }
...
HierarchyTreeView.Renderer.recordRowTemplate = 'vtt_hierarchy_list.hierarchyTree.RecordRow'

registry.category("views").add("hierarchy_tree_view", HierarchyTreeView);