...
class VttInventoryHistoryWizard(models.TransientModel):
    ...
    def open_at_date(self):
        ...
        action = {
            ...
            'domain': domain,
            'context': dict(self.env.context, to_date=self.date_to, from_date=self.date_from, search_default_filter_period_change=1),
        }
        return action
