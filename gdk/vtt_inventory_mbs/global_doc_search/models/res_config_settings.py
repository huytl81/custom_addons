...
class ResConfigSettings(models.TransientModel):
    ...
    sh_global_document_search_action_target_type = fields.Selection(related='company_id.sh_global_document_search_action_target_type',string='Document Open Mode', readonly = False)
