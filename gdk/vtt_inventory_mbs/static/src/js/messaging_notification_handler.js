...
registerInstancePatchModel('mail.messaging_notification_handler', 'vtt_inventory_mbs/static/src/js/messaging_notification_handler.js', {
    ...
    async _handleNotificationPartner(data) {   
        ...
        if (str_msg) {
            ...
            //play sound
            var src = "/vtt_inventory_mbs/static/src/sounds/picked.wav";
        ...
        if (str_msg) {
            ...
            //play sound
            var src = "/vtt_inventory_mbs/static/src/sounds/error.wav";
            $("body").append('<audio src="' + src + '" autoplay="true"></audio>');
        }
        //for play sound ends here    	
