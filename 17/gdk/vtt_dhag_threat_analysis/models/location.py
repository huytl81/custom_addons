    ...
    def create(self, vals):
        ...
        for loc in location:
            partner_vals = {
                ...
                'street2': loc.ward,
                'city': loc.district,
                'state_id': loc.state_id.id,
                'country_id': loc.country_id.id,
                'company_type': 'company',
                'lang': self.env.lang,
                'email': loc.email,
                'phone': loc.phone,
                'partner_latitude': loc.partner_latitude,
                'partner_longitude': loc.partner_longitude,
            }
