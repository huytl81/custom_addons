...
import { Component, useState, useEffect, xml, onWillStart, useComponent } from "@odoo/owl";
...
class RibbonWidget extends Component {
    ...
    initText() {
        if (this.props.record &&
            ...
            this.props.record.data.ribbon_text) {
            this.props.title = this.props.record.data.ribbon_text;
            this.props.text = this.props.record.data.ribbon_text;
        }
    }
