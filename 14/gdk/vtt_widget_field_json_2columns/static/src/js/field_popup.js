odoo.define('vtt_widgets.field_popup', function (require) {
"use strict";
...
var ShowPaymentLineWidget = FieldChar.extend({
//    events: _.extend({
//        'click .outstanding_credit_assign': '_onOutstandingCreditAssign',
//    }, FieldChar.prototype.events),
...
//        });
        if(this.mode == "edit")
            this._super();
        var $infoPopup = $(QWeb.render('FieldPopup', {}));
        this.$el.append($infoPopup);
//        this.$el.html(QWeb.render('FieldPopup', {
//
//        }));
////        this.$el.html(QWeb.render('FieldPopup', {
////            lines: info.content,
...
////        }));
        ...
        _.each(this.$('.js_payment_info'), function (k, v){
            ...
            var options = {
//                content: function () {
//                    var $content = $(QWeb.render('PaymentPopOver1', content));
...
//                    return $content;
//                },
                content: self.value ? self.value : '',
                html: true,
                placement: isRTL ? 'bottom' : 'left',
                title: 'Payment 222 Information',
                trigger: 'focus',
...
field_registry.add('field_popup', ShowPaymentLineWidget);
