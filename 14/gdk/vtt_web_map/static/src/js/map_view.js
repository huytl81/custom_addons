odoo.define('vtt_web_map.MapView', function (require) {
"use strict";

const MapModel = require('vtt_web_map.MapModel');
const MapController = require('vtt_web_map.MapController');
const MapRenderer = require('vtt_web_map.MapRenderer');
...
const MapView = AbstractView.extend({
    jsLibs: [
        '/vtt_web_map/static/lib/leaflet/leaflet.js',
    ],
