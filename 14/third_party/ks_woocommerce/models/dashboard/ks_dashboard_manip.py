...
class KsDashboard(models.Model):
    ...
    def _fetch_graph_data(self):
        ...
        failed_data = {}
        # For Product
        ks_product_new_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'product_template'), ('state', '=', 'new')])
        ks_product_progress_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'product_template'), ('state', '=', 'progress')])
        ks_product_done_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'product_template'), ('state', '=', 'done')])
        ks_product_failed_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'product_template'), ('state', '=', 'failed')])

        # For Variants
        ks_variant_new_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'product_product'), ('state', '=', 'new')])
        ks_variant_progress_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'product_product'), ('state', '=', 'progress')])
        ks_variant_done_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'product_product'), ('state', '=', 'done')])
        ks_variant_failed_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'product_product'), ('state', '=', 'failed')])

        # For Attributes
        ks_attribute_new_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'attribute'), ('state', '=', 'new')])
        ks_attribute_progress_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'attribute'), ('state', '=', 'progress')])
        ks_attribute_done_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'attribute'), ('state', '=', 'done')])
        ks_attribute_failed_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'attribute'), ('state', '=', 'failed')])

        # For Category
        ks_category_new_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'category'), ('state', '=', 'new')])
        ks_category_progress_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'category'), ('state', '=', 'progress')])
        ks_category_done_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'category'), ('state', '=', 'done')])
        ks_category_failed_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'category'), ('state', '=', 'failed')])

        # For Tags
        ks_tag_new_count = self.env['ks.woo.queue.jobs'].search_count([('ks_model', '=', 'tag'), ('state', '=', 'new')])
        ks_tag_progress_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'tag'), ('state', '=', 'progress')])
        ks_tag_done_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'tag'), ('state', '=', 'done')])
        ks_tag_failed_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'tag'), ('state', '=', 'failed')])

        # For Coupons
        ks_coupon_new_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'coupon'), ('state', '=', 'new')])
        ks_coupon_progress_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'coupon'), ('state', '=', 'progress')])
        ks_coupon_done_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'coupon'), ('state', '=', 'done')])
        ks_coupon_failed_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'coupon'), ('state', '=', 'failed')])

        # For Customers
        ks_customer_new_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'customer'), ('state', '=', 'new')])
        ks_customer_progress_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'customer'), ('state', '=', 'progress')])
        ks_customer_done_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'customer'), ('state', '=', 'done')])
        ks_customer_failed_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'customer'), ('state', '=', 'failed')])

        # For Orders
        ks_order_new_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'sale_order'), ('state', '=', 'new')])
        ks_order_progress_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'sale_order'), ('state', '=', 'progress')])
        ks_order_done_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'sale_order'), ('state', '=', 'done')])
        ks_order_failed_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'sale_order'), ('state', '=', 'failed')])

        # For Delivery
        ks_delivery_new_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'delivery'), ('state', '=', 'new')])
        ks_delivery_progress_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'delivery'), ('state', '=', 'progress')])
        ks_delivery_done_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'delivery'), ('state', '=', 'done')])
        ks_delivery_failed_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'delivery'), ('state', '=', 'failed')])

        # For Invoices
        ks_invoice_new_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'invoice'), ('state', '=', 'new')])
        ks_invoice_progress_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'invoice'), ('state', '=', 'progress')])
        ks_invoice_done_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'invoice'), ('state', '=', 'done')])
        ks_invoice_failed_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'invoice'), ('state', '=', 'failed')])

        # For Refunds
        ks_refund_new_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'refund'), ('state', '=', 'new')])
        ks_refund_progress_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'refund'), ('state', '=', 'progress')])
        ks_refund_done_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'refund'), ('state', '=', 'done')])
        ks_refund_failed_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'refund'), ('state', '=', 'failed')])

        # For Payment Gateway
        ks_payment_new_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'payment_gateway'), ('state', '=', 'new')])
        ks_payment_progress_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'payment_gateway'), ('state', '=', 'progress')])
        ks_payment_done_count = self.env['ks.woo.queue.jobs'].search_count(
            [('ks_model', '=', 'payment_gateway'), ('state', '=', 'done')])
        ks_payment_failed_count = self.env['ks.woo.queue.jobs'].search_count(
