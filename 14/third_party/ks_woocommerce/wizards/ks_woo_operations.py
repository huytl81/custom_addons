...
class KsWooInstanceOperation(models.TransientModel):
    ...
    ks_instances = fields.Many2many('ks.woo.connector.instance', string="Instance", required=True,
                                    default=lambda self: self._get_default_ks_woo_instances_ids(), help="Displays WooCommerce Instance Name")
    ...
    ks_operation_odoo = fields.Selection([('import_product', 'Import Product'),
                                          ...
                                          ], string="Import Operation", help="It include the list of operation that can be performed for Import Operation")
    ks_operation_woo = fields.Selection([('export_product', 'Export Product'),
                                         ...
                                         ('export_coupons', 'Export Coupons')
                                         ], string="Export Operation", help="It include the list of operation that can be performed for Export Operation")
    ks_want_all = fields.Boolean(string="Want to select all operations ?", help=" Checkbox allows you to select all the operation at one click`")
    ...
    ks_get_specific_import_type = fields.Selection([('import_all', "Import All "),
                                                   ...
                                                   default="import_all",
                                                   string="Import with", help="It include the list of types of import functionalities.")
    ...
    def ks_execute_operation(self):
        if self.ks_operation_flow == 'odoo_to_woo' and (not self.ks_operation_woo and not self.ks_update_coupons \
